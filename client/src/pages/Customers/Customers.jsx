...
import CustomerModal from '../../components/Modal/CustomerModal.jsx'
  ...
  return (
    <div className="h-[full] min-h-[85vh] pt-2 p-5 bg-blue-50">
      ...
      <div className='pb-5 flex justify-between itmes-center'>
        ...
        <div className='text-[42px] font-bold text-[#0dccd6]'>Customers Details</div>
        </div>
        <div className='flex items-center'>
          <button class="bg-[#0B81C7] text-white font-bold py-2 px-4 rounded hover:bg-[#0dccd6]" onClick={handleOpenModal}>Add New Customer Details</button>
        </div>
      </div>
      ...
      {/* Invoice Form Modal */} 
      <CustomerModal isOpen={isModalOpen} onClose={handleCloseModal} />  
    </div>
  );
}
